...
Node.prototype.insertAfter=function(ele){
    let next=this.nextElementSbling;
...
//页面滚动
Node.prototype.mousewheel=function mousewheel(dom,upwheel,downwheel) {
...
// function Cookie(key,value,time) {
//     this.key=key;
//     this.value=value;
//     this.time=time;
// }
...
//     if(this.time){
//         let now=new Date();
//         now.setTime(now.getTime()+this.time*1000)
//         document.cookie=this.key+'='+this.value+";expires="+now.toGMTString();
//     }else{
...
//         document.cookie=this.key+'=;expires'+now.toGMTString();
//     }
// }
//
//
